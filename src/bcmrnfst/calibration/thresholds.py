...
from bcmrnfst.prototype.bank import prototype_scores, reduce_prototype_scores
...
def recalibrate_global_threshold_grid_search(model: BCMRNFSTModel) -> float:
...
def recalibrate_global_threshold_evt(model: BCMRNFSTModel) -> float:
...
def recalibrate_global_threshold_loco(model: BCMRNFSTModel) -> float:
...
def fit_per_prototype_thresholds(model: BCMRNFSTModel) -> dict[str, float]:
...
def fit_per_class_quantile_thresholds(model: BCMRNFSTModel) -> dict[str, float]:
...
def recalibrate_global_threshold(model: BCMRNFSTModel) -> float:
