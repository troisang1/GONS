...
from bcmrnfst.config.model import ScoringMode
...
def cap_prototype_bank(model: BCMRNFSTModel) -> BCMRNFSTModel:
...
def rebuild_dense_proto_arrays(model: BCMRNFSTModel) -> BCMRNFSTModel:
...
def refresh_prototype_tau_overrides(model: BCMRNFSTModel) -> BCMRNFSTModel:
