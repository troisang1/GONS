...
from gons.baselines import update_baseline_model
from gons.continual import consolidated_refresh
...
def run_fscil_experiment(
    ...
    *,
    ...
    config = load_fscil_config(config_path, repo_root=root)
    if seed is not None:
...
def _is_bc_fscil_state(model_state: ModelState) -> bool:
